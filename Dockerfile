...
ARG CACHE_BUST=random64_20260311_v9
...
RUN mkdir -p /home/root && \
    ...
    touch /home/root/golden.patch  # Allow empty golden patch for DV tasks
USER ubuntu
...
# Anthropic API Key for Claude agent (can be overridden at runtime)
